...
| i     |        | yes    | char   | left                 |                            |
| I     |        | yes    | char   | top of line          | first non-blank,visual use |
| a     |        | yes    | char   | right                |                            |
| A     |        | yes    | char   | end of line          |                            |
| s     | yes    | yes    | char   | del current          |                            |
| S     | yes    | yes    | line   | del done top of line | down count                 |
...
| cc    | yes    | yes    | line   | current              | cc=S,no prefix             |
...
| leader | 	org-ctrl-c-ctrl-c           | tags     | outline same?                |
| :      | 	org-set-tags                | tags     | outline same?                |
| A      | 	org-archive-subtree         | archive  |                              |
| a      | 	org-agenda                  | agenda   |                              |
| .      | 	org-time-stamp              |          |                              |
| b      | 	org-tree-to-indirect-buffer | indirect |                              |
...
| L      | 	org-shiftright              | TODO     | outline                      |
| H      | 	org-shiftleft               | CLOSED   | outline                      |
| K      | 	org-shiftup                 | #A       | outline                      |
| J      | 	org-shiftdown               | #B       | outline                      |
| C-S-l  | 	org-shiftcontrolright       |          |                              |
| C-S-h  | 	org-shiftcontrolleft        |          |                              |
| C-S-j  | 	org-shiftcontroldown        |          | Switch to previous TODO set. |
...
| H         | org-beginning-of-line                         | beginning     |
| L         | org-end-of-line                               | end of line   |
